...
std::map<std::string, uint16_t> ads_port_map = { 
    { "LOGGER", AMSPORT_LOGGER },
    { "RTIME", AMSPORT_R0_RTIME },
    { "TRACE", AMSPORT_R0_TRACE },
    { "IO", AMSPORT_R0_IO },
    { "SPS", AMSPORT_R0_SPS },
    { "NC", AMSPORT_R0_NC },
    { "ISG", AMSPORT_R0_ISG },
    { "PCS", AMSPORT_R0_PCS },
    { "PLC", AMSPORT_R0_PLC },
    { "PLC_RTS1", AMSPORT_R0_PLC_RTS1 },
    { "PLC_RTS2", AMSPORT_R0_PLC_RTS2 },
    { "PLC_RTS3", AMSPORT_R0_PLC_RTS3 },
    { "PLC_RTS4", AMSPORT_R0_PLC_RTS4 },
    { "PLC_TC3", AMSPORT_R0_PLC_TC3 }
};
